...
class Data {
  ...
  Data.fromJson(dynamic json) {
    isAccessTokenValid = json['is_access_token_valid'];
    isEmailVerified = json['isEmailVerified'];
    userData = json['userData'];
    pages = json['pages'] != null ? Pages.fromJson(json['pages']) : null;
    refreshUrl = json['refresh_url'];
    welcomeText = json['welcome_text'];
    onBoardingText = json['onBoardingText'] != null ? OnBoardingText.fromJson(json['onBoardingText']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    map['is_access_token_valid'] = isAccessTokenValid;
    map['isEmailVerified'] = isEmailVerified;
    map['userData'] = userData;
    if (pages != null) {
      map['pages'] = pages?.toJson();
    }
    map['refresh_url'] = refreshUrl;
    map['welcome_text'] = welcomeText;
    if (onBoardingText != null) {
      map['onBoardingText'] = onBoardingText?.toJson();
    }
    return map;
  }
